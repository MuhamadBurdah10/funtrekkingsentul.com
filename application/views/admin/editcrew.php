    ...
    <div class="container col-lg-9">                      
        <div class="card shadow mb-4">
              <div class="card-header py-3">
                    ...
                    <form method="post" action="<?= BASE_URL().'index.php/Admin/updatecrew'?>" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                       <input type="text" class="form-control" id="" name="nama" value="<?=$crew['id'];?>" hidden="">
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="nama" value="<?=$crew['name'];?>" placeholder="">
