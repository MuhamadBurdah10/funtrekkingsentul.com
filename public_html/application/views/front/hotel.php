				...
				<div class="container mt-0.1">
                    ...
                    foreach ($data->result() as $row):?> 
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img  src="<?= base_url().'assets/img/'.$row->foto_hotel;?>" class="" alt="">	
							</div>
													
							<a class="mt-1">
								<h4><?= $row->nama_hotel; ?></h4>
							</a>
							<p>
								<?= $row->ket_hotel; ?>
							</p>
								<a href="<?= site_url('Admin/detailhotel/'.$row->id_hotel); ?>"" class="genric-btn warning circle arrow mb-3">View Detail</a>
								<div >
							</div>	
						</div>
